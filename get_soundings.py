...
class Sounding(object):
    COLUMNS = ["TYPE","PRESSURE", "HEIGHT", "TEMP", "DEWPT", "WINDDIR", "WINDSPD"]
        ...
        for snd in content:
            ...
            for line in snd.splitlines():
                ...
                if linecode[0] == 254:
                    ...
                    snd_obj.hydro, snd_obj.mxwd, snd_obj.tropl, snd_obj.lines, snd_obj.tindex, snd_obj.source = checks[1], checks[2], checks[3], checks[4], checks[5], checks[6]
                elif linecode[0] == 3:
...
p = Parser("2002060600", "2002060610", "10868")
p.parse()
# print(p.parse())


#p = Parser("FAKE", "news", "122445")
# p.parse()
